...
/**
 * Servlet implementation class chef_d_formations
 */
@WebServlet("/chef_d_formations")
public class chef_d_formations extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public chef_d_formations() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.getServletContext().getRequestDispatcher("/WEB-INF/chef_service/liste_d_formations.jsp").forward(request, response);
	}
