            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
				  ...
				  <!-- form i need -->
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="Ajouter_Mission">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="matricule" value="${sessionScope.matricule}">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Object <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="last-name" name="datedeb"  required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="jours_demande"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
		   
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Departement">Start date
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="type_conge" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="login">Duration
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="jours_demande"  class="form-control col-md-7 col-xs-12">
                      </div>
                     ...
                     <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="login">Place
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="jours_demande"  class="form-control col-md-7 col-xs-12">
                      </div>
                     ...
                     <br>   
                     <h5>Liste des employées désignés</h5>
                     <br>
