            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
				  ...
				  <!-- form i need -->
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="demande_recrutement">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="service" value="${service}">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="login">Skills
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="competences"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
		   
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Departement">Experience
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="experience" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
