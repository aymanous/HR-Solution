...
<body class="nav-md">
  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <tr>
             <td> <c:out value="${ archi.matricule }" /></td>
             <td> <c:out value="${ archi.getDatedeb() }" /></td>
             <td><c:out value="${ archi.getJours_demande() }" /></td>
             <td><c:out value="${ archi.getType_conge() }" /></td>
             <td><c:out value="${ archi.getReponse() }"/></td>
            </tr>         
       </c:forEach>
