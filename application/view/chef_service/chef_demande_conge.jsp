            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
				  ...
				  <!-- form i need -->
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="Demande_Conge">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="login">Number of days
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Departement">Type of holiday
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
