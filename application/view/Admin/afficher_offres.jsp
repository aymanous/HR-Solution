      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-tasks"></i> <span> HR Solution span </span></a>
          </div>
      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <div class="row">
            ...
            <td><c:out value="${ offre.position }" /></td>
            <td><c:out value="${ offre.competences }" /></td>
            <td><c:out value="${ offre.experience }" /></td>
            <td><c:out value="${ offre.description }" /></td>
            <td><c:out value="${ offre.date_pub }" /></td>
             <td><c:out value="${ offre.date_limite }" /></td>
            <td> 
                <c:set var="titleURL">
            
                    <c:url value="Modifier_offre">  
                         <c:param name="id" value="${offre.id}"/>  
                         <c:param name="position" value="${offre.position}"/>
                         <c:param name="competences" value="${offre.competences}"/>
                         <c:param name="experience" value="${offre.experience}"/>
                         <c:param name="description" value="${ offre.description }"/>
                         <c:param name="date_pub" value="${ offre.date_pub }"/>
                         <c:param name="date_limite" value="${offre.date_limite}"/>
                    </c:url>
