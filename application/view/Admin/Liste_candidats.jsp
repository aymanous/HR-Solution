				  ...
				  <!-- form i need -->
				   <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                         <td> <c:out value="${ candidat.id_offre }" /></td>
                         <td><c:out value="${ candidat.id_candidature }" /></td>
                         <td><c:out value="${ candidat.position }" /></td>
                         <td>
                           <c:set var="titleURL">
                            <c:url value="fichiers/${candidat.nomFichier}">  
                            </c:url>        
                           </c:set>
                           <a href="${titleURL}"><c:out value="${ candidat.nomFichier }" /></a>
                         </td>
