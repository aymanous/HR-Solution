      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>HR Solution </span></a>
          </div>
        ...
        <div class="">
          ...
          <div class="page-title">
            <div class="title_left">
              <h3>Review/Modify recruitment informations</h3>
            </div>
                ...
                <div class="x_content">
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    <thead>
                      ...
                      <tbody>
                        <c:forEach var="recrutement" items="${ recrutements }">  
            <tr>
            <td> <c:out value="${ recrutement.id }" /></td>
            <td><c:out value="${ recrutement.service }" /></td>
            <td><c:out value="${ recrutement.position }" /></td>
            <td><c:out value="${ recrutement.competences }" /></td>
            <td><c:out value="${ recrutement.experience}" /></td>
            <td><c:out value="${ recrutement.etat }" /></td>
            <td> 
                <c:set var="titleURL">
            
                    <c:url value="Ajouter_offre">    
                         <c:param name="id" value="${recrutement.id}"/>
                         <c:param name="position" value="${recrutement.position}"/>
                         <c:param name="competences" value="${recrutement.competences}"/>
                         <c:param name="experience" value="${recrutement.experience}"/>                 
                    </c:url>
                   
                </c:set>
              <a href="${titleURL}">Publish</a>
               <c:set var="titleURL">
            
                    <c:url value="refuser_formation">  
                         <c:param name="id" value="${recrutement.id}"/>  
                         <c:param name="indice" value="${ 5 }"/> 
                    </c:url>        
                </c:set>
              <a href="${titleURL}">Refuse</a>
            </td>
            </tr>
            </c:forEach>
