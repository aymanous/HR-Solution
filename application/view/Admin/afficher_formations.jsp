          ...
          <div class="row">
            ...
            <td> 
                <c:set var="titleURL">
                    ...
                    <c:url value="Modifier_formation">  
                         <c:param name="id" value="${formation.id}"/>  
                         <c:param name="service" value="${formation.service}"/>
                         <c:param name="theme" value="${formation.theme}"/>
                         <c:param name="dure_moy" value="${formation.dure_moy}"/>
                         <c:param name="priorite" value="${formation.priorite}"/>
                         <c:param name="budget" value="${formation.budget}"/>
                         <c:param name="date_debut" value="${formation.date_debut}"/>
                         <c:param name="date_fin" value="${formation.date_fin}"/>
                         <c:param name="lieu" value="${formation.lieu}"/>                         
                    </c:url>
              ...
              <a href="${titleURL}">Edit</a>
               <c:set var="titleURL">
                    ...
                    <c:url value="refuser_formation">  
                         <c:param name="id" value="${formation.id}"/>  
                         <c:param name="indice" value="${ 1 }"/> 
                    </c:url>        
                </c:set>
              <a href="${titleURL}">Cancel</a>
               <c:set var="titleURL">
            
                    <c:url value="refuser_formation">  
                         <c:param name="id" value="${formation.id}"/>  
                         <c:param name="indice" value="${ 4 }"/> 
                    </c:url>        
                </c:set>
              <a href="${titleURL}">Restart</a>
            </td>
            </tr>
            </c:forEach>
