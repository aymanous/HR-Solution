            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
				  ...
				  <!-- form i need -->
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="Ajouter_offre">
					
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="matricule">Position <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="matricule" required="required" class="form-control col-md-7 col-xs-12" name="position" value="${param.position}"/>
                      </div>
                    </div>
					
					
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">competences<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="service" required="required" class="form-control col-md-7 col-xs-12" name="competences" value="${param.competences}">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="theme" name="experience" value="${param.experience}" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
  
  
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="login">Description
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Departement">Limit date
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="date_limite"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text"  name="date_pub"  required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
