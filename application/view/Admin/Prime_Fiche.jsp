          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
             ...
             <table id="datatable" class="table table-striped table-bordered">
                   <tbody>
                   <tr><th>Matricule</th><td> <c:out value="${ salaire.matricule}" /></td></tr>
                   <tr><th>Date</th><td> <c:out value="${ salaire.date }" /></td></tr>
                   <tr><th>Number of hours</th><td> <c:out value="${ salaire.nb_heures}" /></td></tr>
                   <tr><th>Hour pay</th><td> <c:out value="${ paie_heure }" /></td></tr>
                   <tr><th>Basic Pay</th><td> <c:out value="${ salaire.nb_heures * paie_heure  }" /></td></tr>
                   <tr><th>Nubber of extra hours</th><td> <c:out value="${ salaire.nb_extra }" /></td></tr>
                   <tr><th>Extra hour pay</th><td> <c:out value="${ pex_heure }" /></td></tr>
                   <tr><th>Extra pay</th><td> <c:out value="${ salaire.nb_extra * pex_heure }" /></td></tr>
                   <tr><th>Bounty</th><td> <c:out value="${ salaire.prime }" /></td></tr>
                   <tr><th>Taxes</th><td> <c:out value="${ salaire.impots }" /></td></tr>
                   <tr><th>Net Salary</th><td> <c:out value="${ salaire.nb_heures * paie_heure + salaire.nb_extra * pex_heure + salaire.prime - salaire.impots  }" /></td></tr>
                   </tbody>
              ...
              <c:set var="salaire" value="${salaire}" scope="session"  />
              <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="get" action="Modifier_Fiche">
