...
<body class="nav-md">
  ...
  <div class="container body">
    ...
    <div class="main_container">
      ...
      <tr>
             <td> <c:out value="${ conge.matricule }" /></td>
             <td> <c:out value="${ conge.getDatedeb() }" /></td>
             <td><c:out value="${ conge.getJours_demande() }" /></td>
             <td><c:out value="${ conge.getType_conge() }" /></td>
             <td><c:out value="${ conge.getReponse() }"/></td>
             <td> 
                <c:set var="titleURL">
            
                    <c:url value="Reponse_conge">  
                         <c:param name="reponse" value="accepted"/>  
                        <c:param name="matricule" value="${conge.matricule}"/> 
                        <c:param name="datedeb" value="${conge.datedeb}"/>
                        <c:param name="jours_demande" value="${conge.jours_demande}"/>  
                    </c:url>
                   
                </c:set>
              <a href="${titleURL}">Accept</a>
             
                  <c:set var="titleURL">
            
                    <c:url value="Reponse_conge">  
                         <c:param name="reponse" value="refused"/>  
                        <c:param name="matricule" value="${conge.matricule}"/>
                        <c:param name="datedeb" value="${conge.datedeb}"/>
                        <c:param name="jours_demande" value="${conge.jours_demande}"/>     
                    </c:url>
