        ...
        <div class="">
          ...
          <div class="page-title">
            <div class="title_left">
              <h3>Review/Modify wage informations</h3>
            </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
				  ...
				  <!-- form i need -->
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="Modifier_Fiche">
					
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="matricule">Bounty <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="prime" required="required" class="form-control col-md-7 col-xs-12" name="prime" value="${salaire.prime}"/>
                      </div>
                    </div>
					
					<div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="matricule">Taxes <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="impots" required="required" class="form-control col-md-7 col-xs-12" name="impots" value="${salaire.impots}"/>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <input type="hidden" name="matricule" value="${ salaire.matricule }" /> 
