        ...
        <section class="login_content">
          <form method="post" action="acceuil" >
            ...
            <div class="separator">
                ...
                <a href="bonjour" class="to_register">apply for a job ?</a>
             
              <div class="clearfix"></div>
              <br />
              <div>
                <h1><i class="fa fa-tasks" style="font-size: 26px;"></i> </h1>

                <p> Human Resource Management System ©2016 All Rights Reserved.</p>
              </div>
            </div>
          </form>
          <!-- form -->
